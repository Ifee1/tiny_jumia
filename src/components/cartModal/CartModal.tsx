...
import SuccessPage from "@/app/sucess/Success";
...
function CartModal() {
  ...
  return (
    <>
      {upgradedPlan ? (
        <div className="w-80 absolute p-4 rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.2)] bg-white top-12 right-0 flex flex-col gap-6 z-20">
          <SuccessPage />
        </div>
      ) : (
                      ...
                      <div className="flex flex-col justify-between w-full">
                        ...
                        <div className="flex justify-between text-sm">
                          ...
                          <span
                            ...
                            onClick={() => removeItem(wixClient, lineItem._id!)}
                          >
                            Remove
                          </span>
                        </div>
